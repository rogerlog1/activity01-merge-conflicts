...
**Response**: It looks like movies that fail the test have higher budgets and tend to have a higher gross revenue.
...
**Response**: It looks like the ok rating gets the least budget and least gross revenue.
...
**Response**: Some patterns I notice include the ok variable having a much larger IQR than the other variables. It also has no outliers, unlike the others. Ok movies have a higher median return on investment, while dubious may be the most safe, as it has the highest Q1.
